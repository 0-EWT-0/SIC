...
use App\Http\Controllers\Controller\SubjectController;
...
Route::get('/formail', function(){
    return view('formail');
})->middleware(['auth', 'verified'])->name('formail');

/* Route::get('/show-subject', function(){
    return view('show-subject');
})->middleware(['auth', 'verified'])->name('show-subject'); */
